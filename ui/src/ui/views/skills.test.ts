...
describe("renderSkills", () => {
  ...
  it("renders ClawHub search results and routes detail/install actions", async () => {
          ...
          clawhubResults: [
            {
              ...
              slug: "github",
              displayName: "GitHub",
              summary: "GitHub integration for OpenJeeves",
              version: "1.2.3",
            },
          ],
          onClawHubDetailOpen,
    ...
    expect(text).toContain("GitHub integration for OpenJeeves");
  ...
  it("opens the ClawHub detail dialog and renders install feedback", async () => {
    ...
    expect(text).toContain("By OpenJeeves (@openclaw)");
